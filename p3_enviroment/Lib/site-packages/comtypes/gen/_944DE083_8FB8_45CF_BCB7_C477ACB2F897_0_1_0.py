...
__all__ = [
    'HeadingLevel_None', 'TreeTraversalOptions_PostOrder',
    'UIA_StyleIdAttributeId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId', 'IUIAutomation6',
    'StyleId_Heading6', 'HeadingLevel7', 'TreeScope',
    'IUIAutomationAnnotationPattern', 'ScrollAmount_NoAmount',
    'IUIAutomation2', 'IUIAutomationSelectionPattern2',
    'AnnotationType_SpellingError', 'UIA_ItemStatusPropertyId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_StylesStyleNamePropertyId', 'StyleId_Custom',
    ...
    'UIA_DocumentControlTypeId', 'HeadingLevel3',
    'UIA_HyperlinkControlTypeId', 'UIA_GridItemRowSpanPropertyId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_ScrollVerticalViewSizePropertyId',
    'IUIAutomationTransformPattern', 'DockPosition_Right',
    'UIA_DropTarget_DroppedEventId', 'UIA_SpreadsheetItemPatternId',
    'IUIAutomationElement8', 'UIA_ItemTypePropertyId',
    'UIA_CustomNavigationPatternId',
    'NotificationKind_ActionCompleted',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_TableColumnHeadersPropertyId', 'WindowVisualState_Minimized',
    'AnnotationType_UnsyncedChange', 'UIA_DragDropEffectsPropertyId',
    'IUIAutomationTransformPattern2', 'UIA_ToolBarControlTypeId',
    'TreeTraversalOptions', 'UIA_UnderlineColorAttributeId',
    'UIA_RangeValuePatternId', 'IUIAutomationElement3',
    'TreeScope_Subtree', 'AnnotationType_Mathematics',
    'UIA_ValuePatternId', 'UIA_IsTransformPatternAvailablePropertyId',
    'ExtendedProperty', 'IUIAutomationElement9',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'IUIAutomationValuePattern', 'IUIAutomationTextPattern2',
    'TextUnit_Paragraph', 'UIA_MarginTrailingAttributeId',
    'IUIAutomationScrollPattern', 'UIA_CalendarControlTypeId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'ToggleState_Indeterminate', 'DockPosition',
    'IUIAutomationTextChildPattern', 'TreeScope_Descendants',
    ...
    'AnnotationType_EditingLockedChange', 'UIA_TabControlTypeId',
    'WindowInteractionState_NotResponding',
    'StructureChangeType_ChildrenBulkAdded', 'HeadingLevel5',
    'UIA_SelectionItemPatternId', 'UIA_MarginBottomAttributeId',
    ...
    'UIA_RangeValueSmallChangePropertyId', 'TreeScope_Ancestors',
    'UIA_NativeWindowHandlePropertyId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'IUIAutomationDockPattern', 'ProviderOptions_UseComThreading',
    'AnnotationType_DeletionChange', 'UIA_SliderControlTypeId',
    'TextPatternRangeEndpoint', 'UIA_ValueValuePropertyId',
    'UIA_MenuModeStartEventId', 'OrientationType_Vertical',
    'UIA_LocalizedLandmarkTypePropertyId',
    'WindowInteractionState_ReadyForUserInteraction',
    'AnnotationType_Comment', 'StyleId_Heading4',
    'OrientationType_None', 'UIA_MenuItemControlTypeId',
    'UIA_TitleBarControlTypeId', 'UIA_TransformCanRotatePropertyId',
    'UIA_Transform2ZoomMinimumPropertyId', 'NavigateDirection',
    'AnnotationType_Footer', 'UIA_FlowsFromPropertyId',
    'ProviderOptions_ProviderOwnsSetFocus', 'UIA_TogglePatternId',
    'AnnotationType_GrammarError', 'HeadingLevel4',
    'UIA_WindowIsModalPropertyId', 'NavigateDirection_FirstChild',
    'StyleId_Subtitle', 'IUIAutomationNotificationEventHandler',
    'IUIAutomationChangesEventHandler', 'UIA_RotationPropertyId',
    'UIA_MenuModeEndEventId', 'UIA_IsSuperscriptAttributeId',
    'ScrollAmount_SmallDecrement', 'UIA_CaretPositionAttributeId',
    'IUIAutomationTextRange', 'UIA_AnimationStyleAttributeId',
    'AnnotationType_DataValidationError', 'ToggleState',
    'UIA_HeadingLevelPropertyId', 'UIA_ProcessIdPropertyId',
    'UIA_OverlineStyleAttributeId', 'ScrollAmount_LargeIncrement',
    'TextUnit', 'UIA_RangeValueMaximumPropertyId',
    'OrientationType_Horizontal', 'IUIAutomationSelectionItemPattern',
    'UIA_LabeledByPropertyId', 'UIA_DescribedByPropertyId',
    'IUIAutomationBoolCondition', 'SynchronizedInputType_KeyUp',
    'StructureChangeType_ChildRemoved',
    'UIA_Selection_InvalidatedEventId', 'IUIAutomationOrCondition',
    'UIA_IsActiveAttributeId', 'UIA_OutlineThicknessPropertyId',
    'UIA_GroupControlTypeId', 'UIA_LandmarkTypePropertyId',
    ...
    'UIA_ClickablePointPropertyId', 'DockPosition_Fill',
    'AnnotationType_Highlighted', 'UIA_NotificationEventId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'NavigateDirection_LastChild', 'IUIAutomation4',
    'StyleId_NumberedList', 'HeadingLevel1',
    'UIA_Drag_DragCompleteEventId', 'StyleId_Heading5',
    'IUIAutomationCondition', 'IUIAutomationExpandCollapsePattern',
    'UIA_IsItalicAttributeId', 'ZoomUnit_SmallIncrement',
    ...
    'AnnotationType_Author', 'UIA_IndentationFirstLineAttributeId',
    'UIA_LocalizedControlTypePropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'SupportedTextSelection_None', 'UIA_CenterPointPropertyId',
    'NavigateDirection_PreviousSibling', 'UIA_TextControlTypeId',
    'StyleId_Emphasis', 'StyleId_BulletedList', 'UIA_TablePatternId',
    'ProviderOptions_ServerSideProvider', 'UIA_FillColorPropertyId',
    ...
    'IUIAutomationDropTargetPattern', 'UIA_MenuOpenedEventId',
    'UIA_DropTarget_DragEnterEventId', 'UIA_IsHiddenAttributeId',
    'UIA_AnnotationTypesAttributeId', 'UIA_ListControlTypeId',
    ...
    'UIA_ProgressBarControlTypeId', 'UIA_IsPasswordPropertyId',
    'RowOrColumnMajor_RowMajor', 'UIA_WindowCanMaximizePropertyId',
    ...
    'IUIAutomationElement2', 'UIA_StylesPatternId',
    'UIA_CultureAttributeId',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'PropertyConditionFlags_IgnoreCase',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_WindowControlTypeId',
    'UIA_ClassNamePropertyId', 'UIA_SizePropertyId',
    ...
    'UIA_OrientationPropertyId', 'UIA_ThumbControlTypeId',
    'AnnotationType_AdvancedProofingIssue', 'IUIAutomation3',
    'UIA_LineSpacingAttributeId', 'UIA_NavigationLandmarkTypeId',
    'UIA_MarginLeadingAttributeId', 'TreeScope_Children',
    'LiveSetting', 'UIA_StructureChangedEventId',
    'UIA_PositionInSetPropertyId', 'UIA_ToolTipControlTypeId',
    'UIA_GridPatternId', 'UIA_TextChildPatternId',
    'IUIAutomationElement', 'IUIAutomationElement5',
    'ConnectionRecoveryBehaviorOptions',
    'UIA_LiveRegionChangedEventId', 'NotificationKind_ItemAdded',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_IsRequiredForFormPropertyId', 'UIA_MenuBarControlTypeId',
    'AnnotationType_Header', 'TextUnit_Document',
    'IUIAutomationStructureChangedEventHandler',
    'IUIAutomationTogglePattern', 'IUIAutomationGridPattern',
    'IUIAutomationTableItemPattern', 'StyleId_Heading3',
    'AnnotationType_CircularReferenceError',
    'UIA_Transform2ZoomLevelPropertyId', 'ZoomUnit_NoAmount',
    'CoalesceEventsOptions_Disabled', 'RowOrColumnMajor_ColumnMajor',
    'AnnotationType_FormulaError', 'UIA_HeaderItemControlTypeId',
    'UIA_SeparatorControlTypeId', 'CoalesceEventsOptions',
    'TreeScope_Parent', 'TreeTraversalOptions_Default',
    'UIA_TransformCanResizePropertyId',
    'UIA_ScrollHorizontallyScrollablePropertyId', 'Polite',
    'IUIAutomationTextRange2', 'IUIAutomationScrollItemPattern',
    'UIA_StatusBarControlTypeId', 'AutomationElementMode',
    'UIA_Transform2ZoomMaximumPropertyId',
    'IUIAutomationGridItemPattern', 'UIA_DataGridControlTypeId',
    'SynchronizedInputType_RightMouseUp',
    'UIA_WindowWindowVisualStatePropertyId',
    'SynchronizedInputType_KeyDown', 'TextUnit_Word',
    'IUIAutomationEventHandler', 'IUIAutomationElement4',
    'UIA_BulletStyleAttributeId', 'UIA_SummaryChangeId',
    'IUIAutomationProxyFactoryEntry', 'StyleId_Quote',
    'UIA_WindowCanMinimizePropertyId', 'UIA_FontNameAttributeId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_ScrollItemPatternId', 'TextUnit_Page',
    'UIA_CustomControlTypeId', 'UIA_GridItemColumnSpanPropertyId',
    'IUIAutomationTextRangeArray', 'IUIAutomationElementArray',
    'UIA_SelectionSelectionPropertyId', 'Off',
    'UIA_InputDiscardedEventId', 'PropertyConditionFlags',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_StylesFillPatternStylePropertyId', 'IUIAutomationElement6',
    'UIA_TableControlTypeId', 'UIA_IsTextPattern2AvailablePropertyId',
    'CoalesceEventsOptions_Enabled', 'UIA_WindowPatternId',
    ...
    'NotificationProcessing', 'IUIAutomationAndCondition',
    'UIA_TableItemPatternId', 'ZoomUnit_SmallDecrement',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_Drag_DragStartEventId', 'UIA_UnderlineStyleAttributeId',
    'ZoomUnit_LargeIncrement', 'NotificationProcessing_MostRecent',
    'UIA_MainLandmarkTypeId', 'UIA_ControllerForPropertyId',
    'UIA_VisualEffectsPropertyId', 'UIA_AppBarControlTypeId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_CapStyleAttributeId',
    'UIA_ScrollPatternId', 'UIA_SelectionActiveEndAttributeId',
    'UIA_DockDockPositionPropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'IUIAutomationSynchronizedInputPattern',
    'WindowInteractionState_Closing', 'UIA_FullDescriptionPropertyId',
    'IUIAutomationTextEditPattern', 'UIA_AriaPropertiesPropertyId',
    'HeadingLevel6',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'ScrollAmount_SmallIncrement', 'ScrollAmount_LargeDecrement',
    'UIA_SpreadsheetPatternId',
    'NotificationProcessing_ImportantMostRecent',
    'IUIAutomationTablePattern',
    'UIA_LegacyIAccessibleStatePropertyId',
    'TextEditChangeType_Composition', 'UIA_PaneControlTypeId',
    'UIA_IsTablePatternAvailablePropertyId', 'HeadingLevel8',
    'UIA_Window_WindowClosedEventId', 'UIA_LiveSettingPropertyId',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_MenuClosedEventId', 'SynchronizedInputType_RightMouseDown',
    'ExpandCollapseState_PartiallyExpanded', 'StyleId_Heading7',
    'UIA_TransformPattern2Id', 'UIA_MultipleViewPatternId',
    'IUIAutomationDragPattern', 'AnnotationType_ExternalChange',
    'UIA_StylesFillColorPropertyId', 'DockPosition_None',
    'UIA_StylesStyleIdPropertyId',
    'UIA_AutomationFocusChangedEventId', 'NavigateDirection_Parent',
    'AutomationElementMode_None',
    'UIA_LegacyIAccessibleValuePropertyId',
    'IUIAutomationCustomNavigationPattern',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_AnnotationDateTimePropertyId',
    'UIA_AnnotationTargetPropertyId', 'AnnotationType_Endnote',
    'UIA_TabsAttributeId', 'StructureChangeType',
    'UIA_DropTarget_DragLeaveEventId', 'CUIAutomation8',
    'UIA_ButtonControlTypeId', 'OrientationType',
    'UIA_InputReachedTargetEventId',
    'UIA_StrikethroughColorAttributeId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'TextEditChangeType_AutoComplete', 'StyleId_Title',
    'ToggleState_Off', 'UIA_LegacyIAccessiblePatternId',
    'UIA_CheckBoxControlTypeId', 'UIA_TextPatternId',
    'UIA_DragPatternId', 'UIA_AfterParagraphSpacingAttributeId',
    ...
    'UIA_ObjectModelPatternId', 'CUIAutomation', 'UiaChangeInfo',
    'UIA_LayoutInvalidatedEventId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_OverlineColorAttributeId', 'DockPosition_Top',
    'UIA_ValueIsReadOnlyPropertyId', 'UIA_InvokePatternId',
    'ProviderOptions_HasNativeIAccessible', 'StyleId_Heading8',
    'RowOrColumnMajor', 'IUIAutomation', 'UIA_AccessKeyPropertyId',
    ...
    'UIA_IsGridPatternAvailablePropertyId', 'UIA_SystemAlertEventId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'AnnotationType_TrackChanges', 'ProviderOptions',
    'UIA_IsEnabledPropertyId', 'StyleId_Heading2',
    'TextPatternRangeEndpoint_End',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_IsOffscreenPropertyId', 'UIA_TransformCanMovePropertyId',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_SpinnerControlTypeId',
    'UIA_FrameworkIdPropertyId', 'UIA_AnnotationPatternId',
    'UIA_GridItemPatternId', 'UIA_FillTypePropertyId',
    'UIA_AutomationIdPropertyId', 'UIA_ControlTypePropertyId',
    'HeadingLevel9', 'IUIAutomationRangeValuePattern',
    'UIA_MenuControlTypeId', 'UIA_TableRowHeadersPropertyId',
    'UIA_RuntimeIdPropertyId', 'UIA_CaretBidiModeAttributeId',
    'SupportedTextSelection_Single', 'ExpandCollapseState',
    'UIA_IsDataValidForFormPropertyId', 'UIA_OutlineColorPropertyId',
    'IUIAutomationCacheRequest', 'UIA_ForegroundColorAttributeId',
    'UIA_ItemContainerPatternId', 'TextUnit_Format',
    'UIA_ToolTipOpenedEventId', 'TextUnit_Line',
    'ExpandCollapseState_Expanded',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_IndentationTrailingAttributeId',
    'PropertyConditionFlags_None',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_VirtualizedItemPatternId', 'UIA_RadioButtonControlTypeId',
    'UIA_DropTargetPatternId', 'AnnotationType_InsertionChange',
    'IUIAutomationPropertyCondition',
    'UIA_GridItemContainingGridPropertyId', 'IUIAutomation5',
    'IUIAutomationEventHandlerGroup',
    'UIA_IsContentElementPropertyId',
    'UIA_StylesFillPatternColorPropertyId',
    'AnnotationType_FormatChange', 'UIA_Drag_DragCancelEventId',
    'UIA_AutomationPropertyChangedEventId',
    'UIA_WindowIsTopmostPropertyId', 'UIA_ExpandCollapsePatternId',
    'UIA_DockPatternId', 'UIA_IsSubscriptAttributeId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_FontWeightAttributeId', 'IUIAutomationProxyFactoryMapping',
    'UIA_SelectionPatternId', 'UIA_FontSizeAttributeId',
    'UIA_SizeOfSetPropertyId', 'UIA_EditControlTypeId',
    'UIA_FormLandmarkTypeId', 'UIA_GridColumnCountPropertyId',
    ...
    'UIA_DragIsGrabbedPropertyId', 'UIA_TabItemControlTypeId',
    'IUIAutomationObjectModelPattern',
    'UIA_ProviderDescriptionPropertyId', 'TextUnit_Character',
    'UIA_TextPattern2Id', 'UIA_IsDragPatternAvailablePropertyId',
    'UIA_CulturePropertyId', 'UIA_HeaderControlTypeId',
    'UIA_InputReachedOtherElementEventId', 'TextEditChangeType_None',
    'IRawElementProviderSimple', 'UIA_NamePropertyId',
    'DockPosition_Bottom', 'IUIAutomationLegacyIAccessiblePattern',
    'ExpandCollapseState_LeafNode', 'UIA_FlowsToPropertyId',
    'DockPosition_Left', 'UIA_TreeItemControlTypeId',
    'UIA_LevelPropertyId', 'UIA_Text_TextChangedEventId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_SayAsInterpretAsMetadataId',
    'WindowInteractionState_Running', 'IUIAutomationWindowPattern',
    'UIA_GridRowCountPropertyId', 'ScrollAmount', 'HeadingLevel2',
    'TextEditChangeType', 'SynchronizedInputType_LeftMouseUp',
    'NotificationProcessing_All', 'UIA_ImageControlTypeId',
    'IUIAutomationProxyFactory', 'UIA_DataItemControlTypeId',
    'StyleId_Normal', 'NotificationProcessing_ImportantAll',
    ...
    'NotificationKind_ActionAborted', 'StyleId_Heading1',
    'UIA_SelectionPattern2Id', 'StyleId_Heading9',
    'UIA_Invoke_InvokedEventId', 'IAccessible',
    'NotificationKind_Other',
    'IUIAutomationPropertyChangedEventHandler',
    'AnnotationType_Sensitive', 'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_IndentationLeadingAttributeId', 'UIA_TextEditPatternId',
    'IUIAutomationTextRange3', 'UIA_Window_WindowOpenedEventId',
    'WindowInteractionState', 'UIA_AriaRolePropertyId',
    'UIA_DragDropEffectPropertyId', 'UIA_IsControlElementPropertyId',
    'Assertive', 'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_SayAsInterpretAsAttributeId', 'ZoomUnit_LargeDecrement',
    'UIA_IsKeyboardFocusablePropertyId', 'AnnotationType_Footnote',
    'NotificationKind_ItemRemoved', 'IUIAutomationTreeWalker',
    'UIA_AnnotationTypesPropertyId', 'NavigateDirection_NextSibling',
    'UIA_IsDialogPropertyId', 'IUIAutomationTextPattern',
    'UIA_StyleNameAttributeId', 'RowOrColumnMajor_Indeterminate',
    'UIA_TableRowOrColumnMajorPropertyId', 'ZoomUnit',
    'UIA_HelpTextPropertyId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'IUIAutomationStylesPattern', 'IUIAutomationInvokePattern',
    'SynchronizedInputType', 'UIA_ListItemControlTypeId',
    'UIA_ChangesEventId', 'UIA_AnnotationAnnotationTypeIdPropertyId',
    'ProviderOptions_NonClientAreaProvider',
    'IUIAutomationSpreadsheetPattern',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_ToolTipClosedEventId', 'ProviderOptions_OverrideProvider'
]

_check_version('1.2.0', 1697023395.691679)
